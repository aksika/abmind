...
**NEVER include ABM-L tags, brackets, or metadata prefixes in your responses.** The `[date, type]` and `[TYPE+FLAGS|...]` format is internal context for YOU — never echo it to the user. Replies must be natural language only.
