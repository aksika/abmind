...
const FULL_EXCLUDE = ["lib", "node_modules", "backups", "working", "secret", "current", "releases", "packages", "logs", "bin", "src", "memory/memory.db", "memory/memory.db-wal", "memory/memory.db-shm", "*.sock", "*.db-wal", "*.db-shm"];
